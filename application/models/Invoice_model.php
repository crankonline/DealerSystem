...
class Invoice_model extends CI_Model
{
    ...
    public function menu_invoice_nonpay_count()
    { //для отображения не оплаченных счетов на оплату
    ...
    public function menu_invoice_pay_count()
    { //для отображения оплаченых счетов которые не связанные с заявками, т.е. оплаченные но не выданные
    ...
    public function enum_operators()
    { //перечисление операторов в свойствах счета на полату
    ...
    public function invoice_create($InvoiceData)
    { //!!!!переписать!!!!
