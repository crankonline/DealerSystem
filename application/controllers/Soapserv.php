...
class Soapserv extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->nusoap_server->wsdl->addComplexType(
                'Invoice', 'complexType', 'struct', 'all', '', array(
            ...
            'id_ownershipForm' => array('name' => 'id_ownershipForm', 'type' => 'xsd:int')
                )
        );


        $this->nusoap_server->wsdl->addComplexType(
                'SellArray', 'complexType', 'array', '', 'SOAP-ENC:Array', array(), array(
            array('ref' => 'SOAP-ENC:arrayType', 'wsdl:arrayType' => 'tns:Sell[]')
                ), 'tns:Sell'
        );
        $this->nusoap_server->wsdl->addComplexType(
                'Sell', 'complexType', 'struct', 'all', '', array(
        ...
        //InvoiceArray
        $this->nusoap_server->wsdl->addComplexType(
                'InvoiceArray', 'complexType', 'array', '', 'SOAP-ENC:Array', array(), array(
        ...
        $this->nusoap_server->register(
                'getInvoice', array('id' => 'xsd:integer'), array('return' => 'tns:Invoice'), 'urn:DealerSystemSoapServer', //namespace
        ...
        //getInvoicesByDate
        $this->nusoap_server->register(
                'getInvoicesByDate', array('dateN' => 'xsd:dateTime', 'dateK' => 'xsd:dateTime'), //parameters
                array('return' => 'tns:InvoiceArray'), //output
                'urn:DealerSystemSoapServer', //namespace
        ...
        $this->nusoap_server->register(
                'getInvoicesByCreateDate', array('dateN' => 'xsd:dateTime', 'dateK' => 'xsd:dateTime'), //parameters
                array('return' => 'tns:InvoiceArray'), //output
                'urn:DealerSystemSoapServer', //namespace
        ...
        $this->nusoap_server->register(
                'getInvoicesByPayDate', array('dateN' => 'xsd:dateTime', 'dateK' => 'xsd:dateTime'), //parameters
                array('return' => 'tns:InvoiceArray'), //output
                'urn:DealerSystemSoapServer', //namespace
        ...
        $this->nusoap_server->register(
                'getInvoicesByRequisitesDate', array('dateN' => 'xsd:dateTime', 'dateK' => 'xsd:dateTime'), //parameters
                array('return' => 'tns:InvoiceArray'), //output
                'urn:DealerSystemSoapServer', //namespace
