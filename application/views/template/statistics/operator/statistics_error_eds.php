...
<div class="container theme-showcase" role="main">
    ...
    <?php else: ?>    
        ...
        <?php endif; ?>
        <div class="jumbotron">
            <form action="<?php echo base_url() . "index.php/statistics/statistics_view_operator_error_eds" ?>" method="post">
        ...
        <?php if (isset($statistics_period_self)): ?>
            <div class="well">
                <h3><span class="glyphicon glyphicon-stats"></span> Статистика за указанный период - <?php echo $UserName ?></h3>
                <table class="table">
                    <thead>
                        <tr>
                            <th>#</th>
                    ...
                    <tbody>
                        ...
                        foreach ($statistics_period_self as $val):
                            ...
                            $val->requisites_creating_date_time . " 00:00/" . $val->requisites_creating_date_time . " 23:59/" . $this->session->userdata['logged_in']['UserID']
