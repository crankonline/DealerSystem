...
<script type="text/javascript">
    ...
    app.controller('IvoiceController', ['$scope', '$http', '$window', 'orderByFilter', function ($scope, $http, $window, orderBy) {
            ...
            $scope.addNewChoice = function () {
                ...
                if ($scope.dataInventory.id_inventory == 1 || $scope.dataInventory.id_inventory == 3 || $scope.dataInventory.id_inventory == 5 || $scope.dataInventory.id_inventory == 6 || $scope.dataInventory.id_inventory == 9) { // тип тмц брать из БД
            ...
            $scope.removeChoice = function (z) {
                if ($scope.inventory_row[z].inventoryId == 1 || $scope.inventory_row[z].inventoryId == 3 || $scope.inventory_row[z].inventoryId == 5 || $scope.inventory_row[z].inventoryId == 6 || $scope.inventory_row[z].inventoryId == 9) {// тип тмц брать из БД
