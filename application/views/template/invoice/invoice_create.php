...
<div class="container theme-showcase" role="main" ng-app="DealerSystem">
    <div ng-controller="InvoiceCreateController">
        ...
        <?php else: ?>
            <div class="alert alert-warning">
                <strong>Памятка: </strong>Внимательно заполните поля ИНН, НАИМЕНОВАНИЕ КОМПАНИИ и ТОВАРОНО МЕТЕРИАЛЬНЫХ
                ЦЕННОСТЕЙ!!!
            </div>
            <form action="<?php echo base_url(); ?>index.php/invoice/invoice_create_save/" method="post">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title"><span class="glyphicon glyphicon-usd"></span> Пречисление товарно
                                материальных ценностей</h3>
                        </div>
                        <div class="panel-body">
                            <table class="table">
                                <thead>
