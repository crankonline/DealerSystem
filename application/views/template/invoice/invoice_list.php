    ...
    <?php else: ?>
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title"><span class="glyphicon glyphicon-file"></span> СЧЕТА НА ОПЛАТУ</h3>
            </div>
            <div class="panel-body">
                <div class="row">
                    ...
                    <form action="<?php echo base_url(); ?>index.php/invoice/invoice_list_view/" method="post">
                        <div class="col-lg-4">
                    ...
                    <div class="col-lg-1">
                        <?php if ($this->session->userdata['logged_in']['Create_Invoice'] == TRUE): ?>
                            <form action="<?php echo base_url(); ?>index.php/invoice/invoice_create_view/">
...
<!--                    <th>Токены</th>
            ...
            <tbody>
                ...
                foreach ($invoice_data as $invoice_item):
                    ?>
                    <tr onclick="window.location.href = '<?php echo base_url() . "index.php/invoice/invoice_show_view/" . $invoice_item->invoice_serial_number ?>'" style="cursor: pointer;"
