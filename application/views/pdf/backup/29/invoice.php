...
<table class="date">
    <tr>
        <td width="653" class="inline">Счет на оплату № <?php echo $data['0']->invoice_serial_number; ?> от <?php echo $data['0']->creating_date_time; ?></td>
...
<table class="details" style="width: 100%; margin-top: 10px;">
    ...
    <tr>
        ...
        <td><b>ИНН <?php echo $data['0']->company_name; ?></b></td>
    </tr>
    <tr>
        <td>Комментарий </td>
