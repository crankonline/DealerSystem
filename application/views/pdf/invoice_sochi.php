...
<table class="date">
    <tr>
        <td width="673" class="inline">Счет на оплату № <?php echo $data['0']->invoice_sochi_serial_number; ?> от <?php echo $data['0']->creating_date_time; ?></td>
...
<table class="details" style="width: 100%; margin-top: 10px;">
    ...
    <tr>
        ...
        <td><b> <?php echo $data['0']->company_name .", ИНН: " . $data[0]->inn.", ". json_decode($data['0']->json)->InvoiceCompanyCity . ", " .
                    json_decode($data['0']->json)->InvoiceCompanyAddress; ?></b></td>
    </tr>
    <tr>
        <td>Комментарий </td>
...
<table class="table_border">
    <tr>
        ...
        <td class="bold" width="5%">Код</td>
        <td class="bold" width="20%">Наименование</td>
    ...
    <?php foreach ($data as $invoice) : ?>
        <tr>
            ...
            <td><?php echo $invoice->count . ' мес'; ?></td>
