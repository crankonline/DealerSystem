...
<table style="width: 100%; border-collapse: collapse;">
    <tr>
        ...
        <td style = "width: 50px;" class="bold italic center"><?php
            echo \Services\Token::fetch([
                'action' => 'getPayInvoiceByTokenID',
                'id' => $Data['id']
            ])->data[0]['FullNumber'];
            ?></td>
...
<table class="tabledata" style="width: 100%; border-collapse: collapse;">
    ...
    foreach($Invoice as $Record) :
        ...
        <tr>
            ...
            <td><?php echo number_format($Record['Price'] / 1.12, 2, '.', ''); ?></td>
            <td><?php echo number_format($Record['Sum'] / 1.12, 2, '.', ''); ?></td>
            <td>12</td>
            <td><?php echo number_format($Record['Sum'] * 12 / 112, 2, '.', ''); ?></td>
            <td><?php echo number_format($Record['Sum'], 2, '.', ''); ?></td>
        </tr>
        <?php $Sum += $Record['Sum']; ?>
    <?php endforeach; ?>
    <tr>
        ...
        <td></td>
        <td></td>
        <td><?php echo number_format($Sum / 1.12, 2, '.', ''); ?></td>
        <td>12</td>
        <td><?php echo number_format($Sum * 12 / 112, 2, '.', ''); ?></td>
